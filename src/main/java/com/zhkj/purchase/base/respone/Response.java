...
public class Response {
    ...
    public Response(String code, String error, Object params, Integer pageSize, Integer page, Long total) {
        this(code,error,params,pageSize,page,total,null);
    }
     ...
     * @param total
     */
    public Response(String code, String error, Object params, Integer pageSize, Integer page, Long total, BigDecimal
            totalPrice) {
        this.code = code;
        this.error = error;
        this.params = params;
