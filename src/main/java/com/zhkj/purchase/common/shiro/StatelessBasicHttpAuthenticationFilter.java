...
/**
 * Des: swagger-shiro拦截器
 * ClassName: StatelessBasicHttpAuthenticationFilter
...
public class StatelessBasicHttpAuthenticationFilter extends BasicHttpAuthenticationFilter{
    ...
    protected AuthenticationToken createToken(ServletRequest request, ServletResponse response) {
        ...
        Token token = new Token("",authenticationToken.getPrincipal(),authenticationToken.getCredentials());
        return token;
    }
